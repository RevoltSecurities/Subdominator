    ...
    try:
        async with aiohttp.ClientSession() as session:
            ...
            tasks = [abuseipdb(domain, session, args),alienvault(domain, session, args), anubis(domain, session, args), bevigil(domain, session, configpath, username, args), binaryedge(domain, session, configpath, username, args),
                     bufferover(domain, session, configpath, username, args), c99(domain, session, configpath, username, args),censys(domain, session, configpath, username, args), certspotter(domain, session, configpath, username, args), chaos(domain, session, configpath, username, args),coderog(domain, session, configpath, username, args),
                     columbusapi(domain, session, args), crtsh(domain, session, args), digitorus(domain, session, args), fofa(domain,session, configpath, username, args),dnsdumpster(domain, session, configpath, username, args), dnsrepo(domain, session, args),
                     ...
                     intelx(domain, session, configpath, username, args), leakix(domain, session, configpath, username, args), myssl(domain, session, args),netlas(domain, session, configpath, username, args), quake(domain, session, configpath, username, args),
